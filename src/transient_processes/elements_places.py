...
class ElementsPlacer:
    ...
    def __init__(self, circuit_topology, voltage_sources_num, current_sources_num, resistors_num, inductors_num, capacitors_num):
        self.layout = {}
    ...
    def distribute_elements(self):
        ...
        remaining_elements = (
            ...
            ['inductor'] * i_num +
            ['capacitor'] * c_num +
            [random.choice(['opening_switch', 'closing_switch'])]
        )
